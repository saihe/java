...
public class operationbk {
	...
	*/
	ArrayList<ArrayList<String>> list=new ArrayList<ArrayList <String>>();//二次元配列の生成
	...
	//データを配列
	public ArrayList<ArrayList<String>> listUp(){
		/*
	...
	//更新
	public ArrayList<ArrayList<String>> update(int f , int s , String u){
		//入力された数値で更新する配列を選ぶ
		switch(f){
		case 0:
			date.set(s ,  u);
